...
----
oc apply -f apps/kubefiles/myboot-deployment-live-ready.yml
----
...
[source,bash,subs="+macros,+attributes"]
----
oc apply -f apps/kubefiles/myboot-deployment-live-ready-aggressive.yml
----
...
[source,bash,subs="+macros,+attributes"]
----
oc apply -f apps/kubefiles/myboot-deployment-startup-live-ready.yml
----
...
[source,bash,subs="+macros,+attributes"]
----
oc describe pod myboot-579cc5cc47-2bk5p
----
